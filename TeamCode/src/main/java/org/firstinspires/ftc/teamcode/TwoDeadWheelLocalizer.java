...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -1694.3000620413923; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0.0002832236029526546; // x position of the perpendicular encoder (in tick units)
    }
