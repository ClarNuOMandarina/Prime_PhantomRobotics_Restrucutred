...
public class LocalizationTest extends LinearOpMode {
    ...
    public static double extendz=0.87;
    public static double scoring_left_arm=0;
    public static double scoring_right_arm=0;
    public static double colecting_arms=0.77;
    public static double gripz=0;
    public static double transfer_gripz=0;
    public static double gripz_rotation=0;
    public static double gripz_angle=0.13;
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        if (TuningOpModes.DRIVE_CLASS.equals(MecanumDrive.class)) {
            MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(7.2, -62, Math.toRadians(-90)));
