...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =   -1757.285012012853; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1775.6589806391105; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  2748.047242887804; // x position of the perpendicular encoder (in tick units)
    }
