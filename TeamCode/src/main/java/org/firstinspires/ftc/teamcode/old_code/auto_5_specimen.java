...
//public class auto_5_specimen extends LinearOpMode {
//
//
//    @Override
...
//        scoring.scoring_arm_score_specimen_score();slides.reset_encoder();
...
//        TrajectoryActionBuilder transfer_sample_1 = drive.actionBuilder(new Pose2d(new Vector2d(32,-40),Math.toRadians(90)))
...
//                .splineTo(new Vector2d(38,-45),Math.toRadians(84));
...
//        TrajectoryActionBuilder scoring_poz_4 = drive.actionBuilder(new Pose2d(new Vector2d(0,-42),Math.toRadians(-94)))
//                .afterTime(0.1,slides.auto_score())
//                .lineToY(-35)
//                                .afterTime(0,scoring.specimen_score_2());
//
//        TrajectoryActionBuilder parking = drive.actionBuilder(new Pose2d(new Vector2d(0,-42),Math.toRadians(-94)))
//                .afterTime(0.3,scoring.gripper_release())
//                .afterTime(1,slides.slide_init())
//                .afterTime(0.5,extension.max_extension())
//                .afterDisp(1,scoring.auto_End())
