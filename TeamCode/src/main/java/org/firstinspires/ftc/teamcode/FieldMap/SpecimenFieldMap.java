...
public class SpecimenFieldMap {
    ...
    public Pose2d ScoreFirstSample= new Pose2d(new Vector2d(-40,-58), Math.toRadians(90));

    public Pose2d ScoreSecondSample= new Pose2d(new Vector2d(-40,-58), Math.toRadians(90));
