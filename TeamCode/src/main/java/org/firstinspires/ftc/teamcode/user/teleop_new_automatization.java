...
public class teleop_new_automatization extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d second = new Pose2d(new Vector2d(40, -62), Math.toRadians(90));
...
//                        scoring.init_config();
                ...
                while(is_collecting && !specimen_is_collected && specimen_cycling && gamepad1.left_trigger==0 && is_collected){
                    ...
                    TrajectoryActionBuilder finish_spec_new = drive.actionBuilder(drive.pose)
                            .strafeToLinearHeading(new Vector2d(-2, -38), Math.toRadians(120))
                                .afterTime(1.4, scoring.specimen_collect())
                                .afterTime(0.4, colection.collecting_arm_score())
                                .afterTime(1, scoring.gripper_grab())
                                .afterTime(1.2, colection.griper_release())
                                .afterTime(1.4, scoring.gripper_grab())
