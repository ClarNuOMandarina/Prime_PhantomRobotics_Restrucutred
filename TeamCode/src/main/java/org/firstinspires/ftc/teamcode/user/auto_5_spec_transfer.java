...
@Autonomous(name="auto 5 spec transfer")
public class auto_5_spec_transfer extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder transfer_sample_2 = drive.actionBuilder(new Pose2d(new Vector2d(56,-49.5),Math.toRadians(90)))
...
//                .strafeToLinearHeading(new Vector2d(40,-58),Math.toRadians(90));
        TrajectoryActionBuilder specimen_collect_pre = drive.actionBuilder(new Pose2d(new Vector2d(57,-48),Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(57,-49),Math.toRadians(90));
